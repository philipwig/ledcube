...
user.org:user:led_driver_top:1.0\
...
proc create_root_design { parentCell } {
  ...
  set HUB75_0 [ create_bd_intf_port -mode Master -vlnv me:user:HUB75_rtl:1.0 HUB75_0 ]

  set HUB75_1 [ create_bd_intf_port -mode Master -vlnv me:user:HUB75_rtl:1.0 HUB75_1 ]
...
\
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins led_driver_top_0/S_AXIF]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins led_driver_top_0/S_AXIL]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M01_AXI] [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_intf_net -intf_net led_driver_top_0_HUB75_0 [get_bd_intf_ports HUB75_0] [get_bd_intf_pins led_driver_top_0/HUB75_0]
  connect_bd_intf_net -intf_net led_driver_top_0_HUB75_1 [get_bd_intf_ports HUB75_1] [get_bd_intf_pins led_driver_top_0/HUB75_1]

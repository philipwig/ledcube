...
#
# panel_driver.tcl: Tcl script for re-creating project 'panel_driver'
#
# Generated by Vivado on Sat Apr 08 00:17:31 CDT 2023
...
#
# 1. This project restoration tcl script (panel_driver.tcl) that was generated.
#
...
#
#    "/home/philip/ledcube/hdl/src/constraints/debug.xdc"
#    "/home/philip/ledcube/hdl/src/constraints/snickerdoodle_constraints.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/constraints/debug.xdc"]"\
 "[file normalize "$origin_dir/src/constraints/snickerdoodle_constraints.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/work/[file normalize "$origin_dir/src/led_driver"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "panel_driver"
...
set script_file "panel_driver.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/work/panel_driver"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/src/led_driver"]" $obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/src/constraints/snickerdoodle_constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constraints/snickerdoodle_constraints.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M01_AXI] [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_driver_top_0/S_AXIF/reg0] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_driver_top_0/S_AXIL/reg0] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.0",
   "Default View_TopLeft":"-274,-684",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1170 -y -360 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1170 -y -340 -defaultsOSRD
preplace port HUB75_0 -pg 1 -lvl 4 -x 1170 -y -230 -defaultsOSRD
preplace port HUB75_1 -pg 1 -lvl 4 -x 1170 -y -210 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 220 -y -270 -defaultsOSRD
preplace inst led_driver_top_0 -pg 1 -lvl 3 -x 1000 -y -220 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 630 -y -260 -defaultsOSRD
preplace inst rst_ps7_0_49M -pg 1 -lvl 2 -x 630 -y -80 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 3 -x 1000 -y -450 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 -440 410 -380 830
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 400 -220n
preplace netloc rst_ps7_0_49M_peripheral_aresetn 1 1 2 420 -370 820
preplace netloc axi_smc_M00_AXI 1 2 1 800J -480n
preplace netloc axi_smc_M01_AXI 1 2 1 810J -460n
preplace netloc led_driver_top_0_HUB75_0 1 3 1 NJ -230
preplace netloc led_driver_top_0_HUB75_1 1 3 1 NJ -210
preplace netloc processing_system7_0_DDR 1 1 3 NJ -360 N -360 N
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ -340 N -340 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 400J -320n
levelinfo -pg 1 0 220 630 1000 1170
pagesize -pg 1 -db -bbox -sgen 0 -580 1280 200
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/work/panel_driver/panel_driver.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/panel_driver.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/panel_driver.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/panel_driver.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj

...
### JA1.11 (IO_L6P_T0_35)
set_property PACKAGE_PIN F16 [get_ports {disp_addr_0[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {disp_addr_0[0]}]
set_property PULLUP true [get_ports {disp_addr_0[0]}]

### JA1.12 (IO_L1N_T0_AD0N_35)
set_property PACKAGE_PIN B20 [get_ports {disp_addr_0[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {disp_addr_0[1]}]
set_property PULLUP true [get_ports {disp_addr_0[1]}]

### JA1.13 (IO_L6N_T0_VREF_35)
set_property PACKAGE_PIN F17 [get_ports {disp_addr_0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {disp_addr_0[2]}]
set_property PULLUP true [get_ports {disp_addr_0[2]}]

### JA1.14 (IO_L1P_T0_AD0P_35)
set_property PACKAGE_PIN C20 [get_ports {disp_addr_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {disp_addr_0[3]}]
set_property PULLUP true [get_ports {disp_addr_0[3]}]

### JA1.17 (IO_L3P_T0_DQS_AD1P_35)
set_property PACKAGE_PIN E17 [get_ports {disp_addr_0[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {disp_addr_0[4]}]
set_property PULLUP true [get_ports {disp_addr_0[4]}]
...
set_property PACKAGE_PIN F19 [get_ports disp_r0_0]
set_property IOSTANDARD LVCMOS33 [get_ports disp_r0_0]
set_property PULLUP true [get_ports disp_r0_0]

### JA1.24 (IO_L18N_T2_AD13N_35)
set_property PACKAGE_PIN G20 [get_ports disp_g0_0]
set_property IOSTANDARD LVCMOS33 [get_ports disp_g0_0]
set_property PULLUP true [get_ports disp_g0_0]

### JA1.25 (IO_L15N_T2_DQS_AD12N_35)
set_property PACKAGE_PIN F20 [get_ports disp_b0_0]
set_property IOSTANDARD LVCMOS33 [get_ports disp_b0_0]
set_property PULLUP true [get_ports disp_b0_0]
...
set_property PACKAGE_PIN J20 [get_ports disp_r1_0]
set_property IOSTANDARD LVCMOS33 [get_ports disp_r1_0]
set_property PULLUP true [get_ports disp_r1_0]

### JA1.30 (IO_L16N_T2_35)
set_property PACKAGE_PIN G18 [get_ports disp_g1_0]
set_property IOSTANDARD LVCMOS33 [get_ports disp_g1_0]
set_property PULLUP true [get_ports disp_g1_0]

### JA1.31 (IO_L17N_T2_AD5N_35)
set_property PACKAGE_PIN H20 [get_ports disp_b1_0]
set_property IOSTANDARD LVCMOS33 [get_ports disp_b1_0]
set_property PULLUP true [get_ports disp_b1_0]
...
set_property PACKAGE_PIN J18 [get_ports disp_clk_0]
set_property IOSTANDARD LVCMOS33 [get_ports disp_clk_0]
set_property PULLUP true [get_ports disp_clk_0]

### JA1.36 (IO_L13N_T2_MRCC_35)
set_property PACKAGE_PIN H17 [get_ports disp_blank_0]
set_property IOSTANDARD LVCMOS33 [get_ports disp_blank_0]
set_property PULLUP true [get_ports disp_blank_0]

### JA1.37 (IO_L14N_T2_AD4N_SRCC_35)
set_property PACKAGE_PIN H18 [get_ports disp_latch_0]
set_property IOSTANDARD LVCMOS33 [get_ports disp_latch_0]
set_property PULLUP true [get_ports disp_latch_0]

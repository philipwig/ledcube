...
################################################################
# This is a generated script based on design: rgb_panel_driver
#
...
# source rgb_panel_driver_script.tcl
...
set design_name rgb_panel_driver
...
proc create_root_design { parentCell } {
  ...
  set block_name display_top
  set block_cell_name display_top_0
  if { [catch {set display_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $display_top_0 eq "" } {
  ...
  connect_bd_net -net display_top_0_display_blank_out [get_bd_ports display_blank_out_0] [get_bd_ports display_blank_out_1] [get_bd_pins display_top_0/display_blank_out]
  connect_bd_net -net display_top_0_display_clk_out [get_bd_ports display_clk_out_0] [get_bd_ports display_clk_out_1] [get_bd_pins display_top_0/display_clk_out]
  connect_bd_net -net display_top_0_display_latch_out [get_bd_ports display_latch_out_0] [get_bd_ports display_latch_out_1] [get_bd_pins display_top_0/display_latch_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins display_top_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins display_top_0/rst] [get_bd_pins xlconstant_0/dout]

...
xilinx.com:user:led_driver_test:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set B0_out_0 [ create_bd_port -dir O B0_out_0 ]
  set B0_out_1 [ create_bd_port -dir O B0_out_1 ]
  set B1_out_0 [ create_bd_port -dir O B1_out_0 ]
  set B1_out_1 [ create_bd_port -dir O B1_out_1 ]
  set G0_out_0 [ create_bd_port -dir O G0_out_0 ]
  set G0_out_1 [ create_bd_port -dir O G0_out_1 ]
  set G1_out_0 [ create_bd_port -dir O G1_out_0 ]
  set G1_out_1 [ create_bd_port -dir O G1_out_1 ]
  set R0_out_0 [ create_bd_port -dir O R0_out_0 ]
  set R0_out_1 [ create_bd_port -dir O R0_out_1 ]
  set R1_out_0 [ create_bd_port -dir O R1_out_0 ]
  set R1_out_1 [ create_bd_port -dir O R1_out_1 ]
  set display_address_out_0 [ create_bd_port -dir O -from 4 -to 0 display_address_out_0 ]
  set display_address_out_1 [ create_bd_port -dir O -from 4 -to 0 display_address_out_1 ]
  set display_blank_out_0 [ create_bd_port -dir O display_blank_out_0 ]
  set display_blank_out_1 [ create_bd_port -dir O display_blank_out_1 ]
  set display_clk_out_0 [ create_bd_port -dir O display_clk_out_0 ]
  set display_clk_out_1 [ create_bd_port -dir O display_clk_out_1 ]
  set display_latch_out_0 [ create_bd_port -dir O display_latch_out_0 ]
  set display_latch_out_1 [ create_bd_port -dir O display_latch_out_1 ]
  ...
  # Create instance: led_driver_test_0, and set properties
  set led_driver_test_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:led_driver_test:1.0 led_driver_test_0 ]
...
Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD\
1#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#SD\
0#SD 0#SD 0#SD 0#SD 0#SD 0#SPI 1#SPI 1#SPI 1#SPI 1#UART 0#UART 0#GPIO#GPIO}\
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins led_driver_test_0/axi_patternbuffer]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins led_driver_test_0/axi_control] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net led_driver_test_0_B0_out [get_bd_ports B0_out_0] [get_bd_ports B0_out_1] [get_bd_pins led_driver_test_0/B0_out]
  connect_bd_net -net led_driver_test_0_B1_out [get_bd_ports B1_out_0] [get_bd_ports B1_out_1] [get_bd_pins led_driver_test_0/B1_out]
  connect_bd_net -net led_driver_test_0_G0_out [get_bd_ports G0_out_0] [get_bd_ports G0_out_1] [get_bd_pins led_driver_test_0/G0_out]
  connect_bd_net -net led_driver_test_0_G1_out [get_bd_ports G1_out_0] [get_bd_ports G1_out_1] [get_bd_pins led_driver_test_0/G1_out]
  connect_bd_net -net led_driver_test_0_R0_out [get_bd_ports R0_out_0] [get_bd_ports R0_out_1] [get_bd_pins led_driver_test_0/R0_out]
  connect_bd_net -net led_driver_test_0_R1_out [get_bd_ports R1_out_0] [get_bd_ports R1_out_1] [get_bd_pins led_driver_test_0/R1_out]
  connect_bd_net -net led_driver_test_0_display_address_out [get_bd_ports display_address_out_0] [get_bd_ports display_address_out_1] [get_bd_pins led_driver_test_0/display_address_out]
  connect_bd_net -net led_driver_test_0_display_blank_out [get_bd_ports display_blank_out_0] [get_bd_ports display_blank_out_1] [get_bd_pins led_driver_test_0/display_blank_out]
  connect_bd_net -net led_driver_test_0_display_clk_out [get_bd_ports display_clk_out_0] [get_bd_ports display_clk_out_1] [get_bd_pins led_driver_test_0/display_clk_out]
  connect_bd_net -net led_driver_test_0_display_latch_out [get_bd_ports display_latch_out_0] [get_bd_ports display_latch_out_1] [get_bd_pins led_driver_test_0/display_latch_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins led_driver_test_0/axi_control_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_49M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_49M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins led_driver_test_0/axi_control_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_49M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_driver_test_0/axi_control/axi_control_reg] -force
